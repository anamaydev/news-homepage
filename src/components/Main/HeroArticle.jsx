    ...
    <article className="flex flex-col gap-3 lg:col-span-2">
      ...
      <div className="flex flex-col gap-3 md:flex-row md:gap-4">
        ...
        <div className="flex flex-col gap-3 flex-1 md:gap-4">
          ...
          <button className="py-1.5 px-4 text-preset-7 text-navy-950 bg-red self-start hover:bg-navy-950 hover:text-white transition-colors duration-500 cursor-pointer">READ MORE</button>
        </div>
      </div>
    </article>
  )
